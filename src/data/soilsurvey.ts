export const soilsurvey = [
  ...
  ,
    ...
    location: 'Hokkaido, Japan',
    time: '2024/06/06 - 2024/06/08',
    soilclassification: 'Melanaquands',
    description: 'Temperate humid volcanic soils.',
    image: '/images/soilsurvey/Hokkaido/Hokkaido_pedon03.tiff',  // ✅ 圖片路徑
    detail: {
      subtitle: 'Detailed Descriptions',
       text: `
      ...
      subimages: ['/images/soilsurvey/Hokkaido/Hokkaido_pedon03_1.jpg'],  // 可選，若要附上細節圖
      }
    }
    ,
    ...
    detail: {
      ...
      subimages: ['/images/soilsurvey/Hokkaido/Hokkaido_pedon08_1.jpg', '/images/soilsurvey/Hokkaido/Hokkaido_pedon08_2.jpg'],  // 可選，若要附上細節圖
      } 
  },
